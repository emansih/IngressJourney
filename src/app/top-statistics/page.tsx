...
export default async function Page(){
    ...
    const mostCapturedPortalInADay = await mostCapturedPortalDay()
    const mostCreatedFieldInADay = await mostCreatedFieldDay()
    const mostCreatedLinkInADay = await mostCreatedLinkDay()
    const mostDeployedResonatorInADay = await mostDeployedResonatorDay()
    const mostDestroyedResonatorInADay = await mostDestroyedResonatorDay()
    const mostModsDeployedInADay = await mostModsDeployedDay()
        ...
        <div>
            ...
            >
                ...
                {mostCapturedPortalInADay[0].captured_count && mostCapturedPortalInADay[0].day && (
                    <ListItem sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                        <BasicInfoCard>
                            <MostCapturedPortal portalCount={mostCapturedPortalInADay[0].captured_count} date={mostCapturedPortalInADay[0].day} />
                        </BasicInfoCard>
                    </ListItem>
                )}

                {mostCreatedFieldInADay[0].day && mostCreatedFieldInADay[0].field_count && mostCreatedLinkInADay[0].link_count && mostCreatedLinkInADay[0].day && (
                    <ListItem sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                        <BasicInfoCard>
                            <MostCreatedFieldLink linkCreated={mostCreatedLinkInADay[0].link_count} linkCreatedDate={mostCreatedLinkInADay[0].day} fieldsCreated={mostCreatedFieldInADay[0].field_count} fieldCreatedDate={mostCreatedFieldInADay[0].day} />
                        </BasicInfoCard>
                    </ListItem>
                )}

                {mostDeployedResonatorInADay[0].resonator_count && mostDeployedResonatorInADay[0].day && mostDestroyedResonatorInADay[0].destroyed_count && mostDestroyedResonatorInADay[0].day && (
                    <ListItem sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                        <BasicInfoCard>
                            <MostDeplyedDestroyedReso resosDeployed={mostDeployedResonatorInADay[0].resonator_count} resosDeployedDate={mostDeployedResonatorInADay[0].day} resosDestroyed={mostDestroyedResonatorInADay[0].destroyed_count} resosDestroyedDate={mostDestroyedResonatorInADay[0].day} />
                        </BasicInfoCard>
                    </ListItem>
                )}
                ...
                { mostModsDeployedInADay[0].mod_count && mostModsDeployedInADay[0].day && (
                    <ListItem sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                        <BasicInfoCard>
                            <MostModsDeployed modsDeployed={mostModsDeployedInADay[0].mod_count} date={mostModsDeployedInADay[0].day} />
                        </BasicInfoCard>
                    </ListItem>
                )}
