    ...
    const handleDrawerItemClick = (text: string) => {
        switch (text) {
            case 'Portal History':
                ...
                break
            case 'Recursion History':
                router.push('/recursion-history')
                break
            case 'Top Statistics':
                router.push('/top-statistics')
                break
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <Drawer
                ...
                <Divider />
                <List>
                    {['Portal History', 'Recursion History', 'Anomaly History', 'Medals History', 'Drone History', 'Media History', 'Top Statistics'].map((text) => (
