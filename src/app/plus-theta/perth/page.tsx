...
// This code assumes that the user went to the +Theta in Perth
...
export default function Page() {
    ...
    useEffect(() => {
        ...
        if (current && current.action) {
            setCurrentInfo({ action: current.action, timestamp: formatTime(current.time, 'Australia/Perth') });
        }
    }, [currentTime, tripData]);

    // Fetch data
    useEffect(() => {
        const startDateTime = "2025-06-14T14:00:00+08:00"
        const endDateTime = "2025-06-14T17:00:00+08:00"
    ...
    return (
        <MapContainer
            defaultCenter={[-31.94934841821302, 115.85449693658654]}
