...
export default function Page() {
    ...
    useEffect(() => {
        ...
        if (current && current.action) {
            setCurrentInfo({ action: current.action, timestamp: formatTime(current.time, 'Asia/Taipei') });
        }
    }, [currentTime, tripData]);

    // Fetch data
    useEffect(() => {
        const startDateTime = "2024-11-02T14:00:00+08:00"
        const endDateTime = "2024-11-02T17:00:00+08:00"
    ...
    return (
        <MapContainer
            defaultCenter={[22.999637651905086, 120.2321728996637]}
