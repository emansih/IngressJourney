...
export default function Page() {
    ...
    useEffect(() => {
        ...
        if (current && current.action) {
            setCurrentInfo({ action: current.action, timestamp: formatTime(current.time, 'Asia/Jakarta') });
        }
    }, [currentTime, tripData]);

    // Fetch data
    useEffect(() => {
        const startDateTime = "2023-07-15T14:00:00+07:00"
        const endDateTime = "2023-07-15T17:00:00+07:00"
    ...
    return (
        <MapContainer
            defaultCenter={[-6.91841148415536, 107.61287445199625]}
