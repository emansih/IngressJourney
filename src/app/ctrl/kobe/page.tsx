...
export default function Page() {
    ...
    useEffect(() => {
        ...
        if (current && current.action) {
            setCurrentInfo({ action: current.action, timestamp: formatTime(current.time, 'Asia/Tokyo') });
        }
    }, [currentTime, tripData]);

    // Fetch data
    useEffect(() => {
        const startDateTime = "2023-09-16T14:00:00+09:00"
        const endDateTime = "2023-09-16T17:00:00+09:00"
    ...
    return (
        <MapContainer
            defaultCenter={[34.689925202446595, 135.1932339785009]}
